...
frequency = vslider("v:violin/h:[1]midi/[0]freq[style:knob]", 440, 50, 2000, 1);
gain = vslider("v:violin/h:[1]midi/[2]gain[style:knob]", 1, 0, 3, 0.01);

bend = vslider("v:violin/h:[1]midi/[1]bend[hidden:1][midi:pitchwheel] [style:knob]",1,0.9,1.1,0.01) : si.polySmooth(gate,0.999,1);
