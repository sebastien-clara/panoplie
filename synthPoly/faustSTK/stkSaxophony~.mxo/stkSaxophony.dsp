...
bend = vslider("v:saxophony/h:[1]midi/[1]bend[hidden:1][midi:pitchwheel][style:knob]",1,0.9,1.1,0.01) : si.polySmooth(gate,0.999,1);
...
frequencyMod = hslider("v:saxophony/h:[3]Nonlinear_Filter/Modulation_Frequency
