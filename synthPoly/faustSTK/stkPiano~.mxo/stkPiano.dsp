...
frequency = vslider("v:piano/h:[1]midi/freq [1][unit:Hz] [tooltip:Tone frequency][style:knob]",440,20,6000,1);
gain = vslider("v:piano/h:[1]midi/gain [1][tooltip:Gain (value between 0 and 1)][style:knob]",1,0,1,0.01);
gate = button("v:piano/h:[1]midi/gate [1][tooltip:noteOn = 1, noteOff = 0]");
bend = vslider("v:piano/h:[1]midi/[1]bend[hidden:1][midi:pitchwheel][style:knob]",1,0.9,1.1,0.01) : si.polySmooth(gate,0.999,1);

freq = frequency*bend;


brightnessFactor = hslider("v:piano/h:[3]Physical/Brightness_Factor
[2][tooltip:A value between 0 and 1][style:knob]",0,0,1,0.01);
detuningFactor = hslider("v:piano/h:[3]Physical/Detuning_Factor
[2][tooltip:A value between 0 and 1][style:knob]",0.1,0,1,0.01)*10;
stiffnessFactor = hslider("v:piano/h:[3]Physical/Stiffness_Factor
[2][tooltip:A value between 0 and 1][style:knob]",0.28,0,1,0.01)*3.7;
hammerHardness = hslider("v:piano/h:[3]Physical/Hammer_Hardness
[2][tooltip:A value between 0 and 1][style:knob]",0.1,0,1,0.01)*0.1;
...
(*(conditionHighNote) : hiPass : dcBlock1 : hammer : dcBlock2a : highBqs : dcBlock2b) :> + : *(1);
