...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 565.0, 544.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "pack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 565.0, 585.932373, 58.0, 22.0 ],
					"style" : "",
					"text" : "route 7 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 565.0, 507.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "swap"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 565.0, 470.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "unpack i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 463.0, 39.5, 85.0, 22.0 ],
					"style" : "",
					"text" : "r #1-selPreset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 520.0, 96.0, 22.0 ],
					"style" : "",
					"text" : "midiNoteFormat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 190.0, 437.432373, 185.0, 22.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 587.0, 79.0, 84.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 587.0, 39.5, 41.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 539.0, 30.5, 41.0, 23.0 ],
					"style" : "",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 194.0, 162.0, 80.0, 20.0 ],
					"style" : "",
					"text" : "v. 20180914",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 162.0, 101.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 34.0, 87.0, 20.0 ],
					"style" : "",
					"text" : "preset number"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 90.969772, 34.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 190.0, 593.932373, 72.0, 22.0 ],
					"style" : "",
					"text" : "s #1-dx7KR"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 190.0, 316.432373, 224.0, 85.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 82.0, 223.939545, 82.0 ],
					"varname" : "selInput",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 361.0, 6.0, 83.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 3.0, 60.0, 29.0 ],
					"style" : "",
					"text" : "DX7",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 142.280212, 142.0, 100.0, 22.0 ],
					"style" : "",
					"text" : "loadmess -15"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 357.530212, 521.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "select 27"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "int", "int", "int" ],
					"patching_rect" : [ 357.530212, 485.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 428.560425, 522.0, 27.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 151.0, 20.5, 30.0, 18.0 ],
					"style" : "",
					"text" : "esc",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 357.530212, 555.932373, 45.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 182.939545, 3.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.530212, 570.932373, 75.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 126.0, 3.0, 55.0, 24.0 ],
					"style" : "",
					"text" : "Panic",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.0, 521.932373, 68.0, 22.0 ],
					"style" : "",
					"text" : "round 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.0, 480.932373, 125.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.0, 556.432373, 175.0, 19.0 ],
					"style" : "",
					"text" : "/Polyphonic/Voices/dx7/global/bend $1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 227.0, 3.0, 45.0, 161.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 20.0, 63.0, 299.0, 745.0 ],
									"varname" : "dx7",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 20.0, 828.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 14.0, 79.0, 100.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 55.0, 223.939545, 24.0 ],
					"style" : "",
					"varname" : "dx7preset"
				}
