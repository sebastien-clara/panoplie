...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("A", &fVslider2, 0.01, 0.0, 15.0, 0.01);
		ui_interface->declare(&fVslider3, "2", "");
		ui_interface->declare(&fVslider3, "style", "knob");
		ui_interface->declare(&fVslider3, "tooltip", "sec");
		ui_interface->addVerticalSlider("D", &fVslider3, 0.059999999999999998, 0.0, 15.0, 0.01);
		...
		ui_interface->addVerticalSlider("R", &fVslider1, 0.10000000000000001, 0.01, 10.0, 0.01);
		ui_interface->closeBox();
