...
bend = vslider("v:bowed/h:[1]midi/[1]bend[hidden:1][midi:pitchwheel] [style:knob]",1,0.9,1.1,0.01) : si.smoo;
portamento = si.smooth(vslider("v:bowed/h:[1]midi/[7]portamento [style:knob]", 0, 0, 5, 0.05) : ba.tau2pole);
...
frequencyMod = hslider("v:bowed/h:[3]Nonlinear_Filter/Modulation_Frequency
