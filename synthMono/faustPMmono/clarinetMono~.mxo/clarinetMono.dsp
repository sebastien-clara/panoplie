...
frequency = vslider("v:clarinet/h:[1]midi/[1]freq[style:knob]", 440, 50, 4000, 1) : portamento;
gain = vslider("v:clarinet/h:[1]midi/[2]gain[style:knob]", 1, 0, 3, 0.01) : si.smoo;

bend = vslider("v:clarinet/h:[1]midi/[1]bend[hidden:1][midi:pitchwheel] [style:knob]",1,0.9,1.1,0.01) : si.smoo;
portamento = si.smooth(vslider("v:clarinet/h:[1]midi/[3]portamento [style:knob]", 0, 0, 5, 0.05) : ba.tau2pole);
