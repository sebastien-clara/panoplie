  ...
  public:
	...
	void fillmydspSIG0(int count, double* output) {
		for (int i = 0; (i < count); i = (i + 1)) {
			iRec12[0] = (iRec12[1] + 1);
			output[i] = std::sin((9.5873799242852573e-05 * double((iRec12[0] + -1))));
			iRec12[1] = iRec12[0];
...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst5 = (0.15873015873015872 * fConst0);
		fConst6 = std::min(20.0, fConst5);
		fConst7 = std::max(20.0, fConst5);
		fConst8 = (1.0 / fConst0);
		fConst9 = (1.0 / fConst0);
		fConst10 = std::exp((0.0 - (1250.0 / fConst0)));
		fConst11 = std::exp((0.0 - (2.0 / fConst0)));
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider1 = FAUSTFLOAT(0.029999999999999999);
		fVslider2 = FAUSTFLOAT(0.90000000000000002);
		...
		fVslider8 = FAUSTFLOAT(220.0);
		fVslider9 = FAUSTFLOAT(0.0);
		fVslider10 = FAUSTFLOAT(0.01);
		fVslider11 = FAUSTFLOAT(0.5);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("freq", &fVslider8, 220.0, 20.0, 5000.0, 10.0);
		ui_interface->declare(&fVslider9, "7", "");
		ui_interface->declare(&fVslider9, "style", "knob");
		ui_interface->addVerticalSlider("portamento", &fVslider9, 0.0, 0.0, 5.0, 0.050000000000000003);
		ui_interface->declare(&fVslider7, "8", "");
		ui_interface->declare(&fVslider7, "hide", "1");
		ui_interface->declare(&fVslider7, "midi", "pitchwheel");
		ui_interface->declare(&fVslider7, "style", "knob");
		ui_interface->addVerticalSlider("bend", &fVslider7, 1.0, 0.90000000000000002, 1.1000000000000001, 0.01);
		...
		ui_interface->addVerticalSlider("modCoef", &fVslider10, 0.01, 0.0, 1.0, 0.01);
		ui_interface->declare(&fVslider6, "2", "");
		ui_interface->declare(&fVslider6, "style", "knob");
		ui_interface->addVerticalSlider("modAmp", &fVslider6, 0.5, 0.050000000000000003, 1.0, 0.01);
		ui_interface->declare(&fVslider11, "3", "");
		ui_interface->declare(&fVslider11, "style", "knob");
		ui_interface->addVerticalSlider("beat", &fVslider11, 0.5, 0.0, 1.0, 0.01);
		ui_interface->declare(&fVslider5, "4", "");
		ui_interface->declare(&fVslider5, "style", "knob");
		ui_interface->addVerticalSlider("resonance", &fVslider5, 0.050000000000000003, 0.0, 1.0, 0.01);
		ui_interface->declare(0, "9", "");
		ui_interface->openHorizontalBox("env");
		ui_interface->declare(&fVslider1, "1", "");
		ui_interface->declare(&fVslider1, "style", "knob");
		ui_interface->declare(&fVslider1, "tooltip", "sec");
		ui_interface->addVerticalSlider("attack", &fVslider1, 0.029999999999999999, 0.01, 5.0, 0.01);
		ui_interface->declare(&fVslider4, "2", "");
		ui_interface->declare(&fVslider4, "style", "knob");
		ui_interface->declare(&fVslider4, "tooltip", "sec");
		ui_interface->addVerticalSlider("decay", &fVslider4, 0.050000000000000003, 0.01, 5.0, 0.01);
		ui_interface->declare(&fVslider2, "3", "");
		ui_interface->declare(&fVslider2, "style", "knob");
		ui_interface->declare(&fVslider2, "tooltip", "percentage of max");
		ui_interface->addVerticalSlider("sustain", &fVslider2, 0.90000000000000002, 0.10000000000000001, 1.0, 0.10000000000000001);
		ui_interface->declare(&fVslider3, "4", "");
		ui_interface->declare(&fVslider3, "style", "knob");
		ui_interface->declare(&fVslider3, "tooltip", "sec");
		ui_interface->addVerticalSlider("release", &fVslider3, 0.29999999999999999, 0.01, 5.0, 0.01);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow8 = double(fVslider6);
		double fSlow9 = double(fVslider7);
		double fSlow10 = (1.5 * fSlow9);
		double fSlow11 = std::exp((0.0 - (fConst8 / double(fVslider9))));
		double fSlow12 = (double(fVslider8) * (1.0 - fSlow11));
		double fSlow13 = (fConst9 * (fSlow9 * double(fVslider10)));
		double fSlow14 = (0.98999999999999999 * fSlow9);
		double fSlow15 = (1.0009999999999999 * fSlow9);
		double fSlow16 = (1.008 * fSlow9);
		double fSlow17 = (0.0010000000000000009 * double(fVslider11));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			double fTemp1 = std::exp((0.0 - (fConst1 / (iSlow1?(iTemp0?fRec3[0]:fRec6[0]):fRec5[0]))));
			fRec1[0] = (((iSlow1?(iTemp0?double(iSlow1):(fSlow3 * fRec4[0])):0.0) * (1.0 - fTemp1)) + (fRec1[1] * fTemp1));
			fRec10[0] = (fSlow7 + (0.999 * fRec10[1]));
			double fTemp2 = mydsp_faustpower2_f((1.4141994202374715 * fRec10[0]));
			double fTemp3 = (1.9999800000000003 * fRec10[0]);
			fRec11[0] = (fSlow12 + (fSlow11 * fRec11[1]));
			double fTemp4 = (fSlow10 * fRec11[0]);
			double fTemp5 = (fRec13[1] + (fSlow13 * fRec11[0]));
			fRec13[0] = (fTemp5 - std::floor(fTemp5));
			double fTemp6 = (65536.0 * fRec13[0]);
			int iTemp7 = int(fTemp6);
			double fTemp8 = ftbl0mydspSIG0[iTemp7];
			double fTemp9 = (fTemp4 + (0.5 * ((fConst5 - fTemp4) * ((fTemp8 + ((fTemp6 - std::floor(fTemp6)) * (ftbl0mydspSIG0[(iTemp7 + 1)] - fTemp8))) + 1.0))));
			double fTemp10 = (fSlow8 * fTemp9);
			double fTemp11 = ((fConst7 * double((fTemp10 > fConst7))) + (fSlow8 * (fTemp9 * double((fTemp10 <= fConst7)))));
			double fTemp12 = std::tan((fConst4 * std::max(((fConst6 * double((fTemp11 < fConst6))) + (fTemp11 * double((fTemp11 >= fConst6)))), 20.0)));
			double fTemp13 = (1.0 / fTemp12);
			double fTemp14 = (fTemp3 + fTemp13);
			double fTemp15 = (1.0 - fTemp3);
			double fTemp16 = ((fTemp2 + ((fTemp13 + (2.0 - fTemp3)) / fTemp12)) + fTemp15);
			double fTemp17 = (((fTemp2 + ((fTemp14 + -2.0) / fTemp12)) + fTemp15) / fTemp16);
			double fTemp18 = std::max(-0.99990000000000001, std::min(0.99990000000000001, fTemp17));
			double fTemp19 = (1.0 - mydsp_faustpower2_f(fTemp18));
			double fTemp20 = std::sqrt(std::max(0.0, fTemp19));
			double fTemp21 = (1.0 / mydsp_faustpower2_f(fTemp12));
			double fTemp22 = (fTemp2 + (1.0 - (fTemp3 + fTemp21)));
			double fTemp23 = std::max(-0.99990000000000001, std::min(0.99990000000000001, (2.0 * (fTemp22 / (fTemp16 * (fTemp17 + 1.0))))));
			double fTemp24 = (1.0 - mydsp_faustpower2_f(fTemp23));
			double fTemp25 = std::sqrt(std::max(0.0, fTemp24));
			double fTemp26 = std::max(9.9999999999999995e-08, std::fabs((fSlow9 * fRec11[0])));
			double fTemp27 = (fRec18[1] + (fConst9 * fTemp26));
			double fTemp28 = (fTemp27 + -1.0);
			int iTemp29 = (fTemp28 < 0.0);
			fRec18[0] = (iTemp29?fTemp27:fTemp28);
			double fRec19 = (iTemp29?fTemp27:(fTemp27 + (fTemp28 * (1.0 - (fConst0 / fTemp26)))));
			double fTemp30 = std::max(9.9999999999999995e-08, std::fabs((fSlow14 * fRec11[0])));
			double fTemp31 = (fRec20[1] + (fConst9 * fTemp30));
			double fTemp32 = (fTemp31 + -1.0);
			int iTemp33 = (fTemp32 < 0.0);
			fRec20[0] = (iTemp33?fTemp31:fTemp32);
			double fRec21 = (iTemp33?fTemp31:(fTemp31 + (fTemp32 * (1.0 - (fConst0 / fTemp30)))));
			double fTemp34 = std::max(9.9999999999999995e-08, std::fabs((fSlow15 * fRec11[0])));
			double fTemp35 = (fRec22[1] + (fConst9 * fTemp34));
			double fTemp36 = (fTemp35 + -1.0);
			int iTemp37 = (fTemp36 < 0.0);
			fRec22[0] = (iTemp37?fTemp35:fTemp36);
			double fRec23 = (iTemp37?fTemp35:(fTemp35 + (fTemp36 * (1.0 - (fConst0 / fTemp34)))));
			double fTemp38 = std::max(9.9999999999999995e-08, std::fabs((fSlow16 * fRec11[0])));
			double fTemp39 = (fRec24[1] + (fConst9 * fTemp38));
			double fTemp40 = (fTemp39 + -1.0);
			int iTemp41 = (fTemp40 < 0.0);
			fRec24[0] = (iTemp41?fTemp39:fTemp40);
			double fRec25 = (iTemp41?fTemp39:(fTemp39 + (fTemp40 * (1.0 - (fConst0 / fTemp38)))));
			fRec26[0] = (fSlow17 + (0.999 * fRec26[1]));
			double fTemp42 = std::max(-1.0, std::min(1.0, (2.5238293779207734 * (((2.0 * fRec19) + ((-1.0 - (2.0 * (1.0 - ((fRec21 + fRec23) + fRec25)))) * fRec26[0])) + -1.0))));
			double fTemp43 = (fTemp42 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp42))));
			fVec0[0] = fTemp43;
			fRec17[0] = (((0.995 * fRec17[1]) + fTemp43) - fVec0[1]);
			double fTemp44 = (fTemp2 + fTemp3);
			double fTemp45 = ((((fTemp14 + 2.0) / fTemp12) + fTemp44) + 1.0);
			double fTemp46 = (((((fTemp13 + (-2.0 - fTemp3)) / fTemp12) + fTemp44) + 1.0) / fTemp45);
			double fTemp47 = std::max(-0.99990000000000001, std::min(0.99990000000000001, fTemp46));
			double fTemp48 = (1.0 - mydsp_faustpower2_f(fTemp47));
			double fTemp49 = std::sqrt(std::max(0.0, fTemp48));
			double fTemp50 = ((fRec17[0] * fTemp49) + (fRec27[1] * (0.0 - fTemp47)));
			double fTemp51 = (fTemp44 + (1.0 - fTemp21));
			double fTemp52 = std::max(-0.99990000000000001, std::min(0.99990000000000001, (2.0 * (fTemp51 / (fTemp45 * (fTemp46 + 1.0))))));
			double fTemp53 = (1.0 - mydsp_faustpower2_f(fTemp52));
			double fTemp54 = std::sqrt(std::max(0.0, fTemp53));
			fRec29[0] = ((fRec29[1] * (0.0 - fTemp52)) + (fTemp50 * fTemp54));
			fRec27[0] = ((fTemp50 * fTemp52) + (fRec29[1] * fTemp54));
			double fRec28 = fRec29[0];
			double fTemp55 = (1.0 - (fTemp51 / fTemp45));
			double fTemp56 = (((fRec17[0] * fTemp47) + (fRec27[1] * fTemp49)) + ((((fRec28 * (1.0 - (fTemp46 + (2.0 * (fTemp52 * fTemp55))))) / std::sqrt(fTemp53)) + (2.0 * (fRec27[0] * fTemp55))) / std::sqrt(fTemp48)));
			double fTemp57 = ((fRec14[1] * (0.0 - fTemp18)) + ((fTemp20 * fTemp56) / fTemp45));
			fRec16[0] = ((fRec16[1] * (0.0 - fTemp23)) + (fTemp25 * fTemp57));
			fRec14[0] = ((fTemp25 * fRec16[1]) + (fTemp23 * fTemp57));
			double fRec15 = fRec16[0];
			double fTemp58 = (1.0 - (fTemp22 / fTemp16));
			double fTemp59 = (((fTemp20 * fRec14[1]) + ((fTemp18 * fTemp56) / fTemp45)) + ((((fRec15 * (1.0 - (fTemp17 + (2.0 * (fTemp23 * fTemp58))))) / std::sqrt(fTemp24)) + (2.0 * (fTemp58 * fRec14[0]))) / std::sqrt(fTemp19)));
			double fTemp60 = std::fabs((0.40000000000000002 * (fTemp59 / fTemp16)));
			double fTemp61 = ((fRec8[1] > fTemp60)?fConst11:fConst10);
			fRec9[0] = ((fRec9[1] * fTemp61) + (fTemp60 * (1.0 - fTemp61)));
			fRec8[0] = fRec9[0];
			fRec7[0] = ((fConst2 * fRec7[1]) + (fConst3 * (0.0 - (0.75 * std::max(((20.0 * std::log10(fRec8[0])) + 6.0), 0.0)))));
			double fTemp62 = (0.20000000000000001 * ((((fRec0[0] * fRec1[0]) * std::pow(10.0, (0.050000000000000003 * fRec7[0]))) * fTemp59) / fTemp16));
