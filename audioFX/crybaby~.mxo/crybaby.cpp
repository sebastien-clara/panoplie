...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider1 = FAUSTFLOAT(0.80000000000000004);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Crybaby");
		ui_interface->declare(&fVslider1, "1", "");
		ui_interface->declare(&fVslider1, "tooltip", "wah pedal angle between 0 (rocked back) and 1 (rocked forward)");
		ui_interface->addVerticalSlider("Wah parameter", &fVslider1, 0.80000000000000004, 0.0, 1.0, 0.01);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow2 = (0.0001000000000000001 * pow(4.0, fSlow1));
		double fSlow3 = pow(2.0, (2.2999999999999998 * fSlow1));
		double fSlow4 = (1.0 - (fConst1 * (fSlow3 / pow(2.0, ((2.0 * (1.0 - fSlow1)) + 1.0)))));
		double fSlow5 = (0.0010000000000000009 * (0.0 - (2.0 * (fSlow4 * cos((fConst2 * fSlow3))))));
		double fSlow6 = (0.0010000000000000009 * mydsp_faustpower2_f(fSlow4));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec0[0] = ((fSlow0 * (fTemp0 * fRec1[0])) - ((fRec2[0] * fRec0[1]) + (fRec3[0] * fRec0[2])));
			output0[i] = FAUSTFLOAT(((fRec0[0] + (fSlow7 * fTemp0)) - fRec0[1]));
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
			fRec0[2] = fRec0[1];
