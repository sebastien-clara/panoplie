...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("description", "Based on a circuit diagram of the Ibanez TS-9 and a mathematical analysis published by Tamás Kenéz");
		m->declare("filename", "distoTubeScreamer");
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst5 = (1.0 / fConst3);
		fConst6 = (9.3999999999999995e-08 * fConst0);
		
	}
	
	virtual void instanceResetUserInterface() {
		fVslider0 = FAUSTFLOAT(400.0);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fVslider1, "name", "Drive");
		ui_interface->declare(&fVslider1, "style", "knob");
		ui_interface->addVerticalSlider("drive", &fVslider1, 0.5, 0.0, 1.0, 0.01);
		ui_interface->declare(&fVslider2, "name", "Level");
		ui_interface->declare(&fVslider2, "style", "knob");
		ui_interface->addVerticalSlider("level", &fVslider2, -16.0, -20.0, 4.0, 0.10000000000000001);
		ui_interface->declare(&fVslider0, "log", "");
		ui_interface->declare(&fVslider0, "name", "Tone");
		ui_interface->declare(&fVslider0, "style", "knob");
		ui_interface->addVerticalSlider("tone", &fVslider0, 400.0, 100.0, 1000.0, 1.03);
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow0 = (1.0 / tan((fConst1 * double(fVslider0))));
		double fSlow1 = (fSlow0 + 1.0);
		double fSlow2 = (0.0 - ((1.0 - fSlow0) / fSlow1));
		double fSlow3 = (1.0 / fSlow1);
		double fSlow4 = (fConst6 * ((500000.0 * double(fVslider1)) + 55700.0));
		double fSlow5 = (fSlow4 + 1.0);
		double fSlow6 = (1.0 - fSlow4);
		double fSlow7 = (0.0010000000000000009 * pow(10.0, (0.050000000000000003 * double(fVslider2))));
		for (int i = 0; (i < count); i = (i + 1)) {
			double fTemp0 = double(input0[i]);
			fVec0[0] = fTemp0;
			fRec1[0] = ((fConst4 * fRec1[1]) + (fConst5 * ((fSlow5 * fTemp0) + (fSlow6 * fVec0[1]))));
			double fTemp1 = (fRec1[0] - fTemp0);
			double fTemp2 = fabs(fTemp1);
			double fTemp3 = (101.97 * (fTemp2 / (fTemp2 + 3.0)));
			double fTemp4 = max(0.0, min(99.0, floor(fTemp3)));
			double fTemp5 = (((0.0 < fTemp4) < 99)?0.0:(fTemp3 - fTemp4));
			double fTemp6 = (fTemp0 - (double((((fTemp2 * double(((fTemp1 < 0.0)?1:-1))) < 0.0)?-1:1)) * fabs(((ftbl0mydspSIG0[int(fTemp4)] * (1.0 - fTemp5)) + (fTemp5 * ftbl0mydspSIG0[int((fTemp4 + 1.0))])))));
			fVec1[0] = fTemp6;
			fRec0[0] = ((fSlow2 * fRec0[1]) + (fSlow3 * (fTemp6 + fVec1[1])));
