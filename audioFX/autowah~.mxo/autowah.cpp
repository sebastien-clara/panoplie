...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fVslider0, "tooltip", "amount of effect desired (0 to 1)");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec2[0] = max(fTemp1, ((fConst1 * fRec2[1]) + (fConst2 * fTemp1)));
			fRec1[0] = ((0.999 * fRec1[1]) + (0.0001000000000000001 * pow(4.0, fRec2[0])));
			double fTemp2 = pow(2.0, (2.2999999999999998 * fRec2[0]));
			double fTemp3 = (1.0 - (fConst3 * (fTemp2 / pow(2.0, ((2.0 * (1.0 - fRec2[0])) + 1.0)))));
			fRec3[0] = ((0.999 * fRec3[1]) + (0.0010000000000000009 * (0.0 - (2.0 * (fTemp3 * cos((fConst4 * fTemp2)))))));
			fRec4[0] = ((0.999 * fRec4[1]) + (0.0010000000000000009 * mydsp_faustpower2_f(fTemp3)));
			fRec0[0] = ((fTemp0 * fRec1[0]) - ((fRec3[0] * fRec0[1]) + (fRec4[0] * fRec0[2])));
