...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("freq", &fHslider3, 3.0, 0.0, 15.0, 0.01);
		ui_interface->declare(&fHslider1, "2", "");
		ui_interface->declare(&fHslider1, "style", "knob");
		ui_interface->addHorizontalSlider("delay", &fHslider1, 0.001, 0.0, 0.20000000000000001, 0.001);
		ui_interface->declare(&fHslider2, "3", "");
		ui_interface->declare(&fHslider2, "style", "knob");
		ui_interface->addHorizontalSlider("depth", &fHslider2, 0.02, 0.0, 1.0, 0.001);
		ui_interface->declare(&fHslider0, "4", "");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->addHorizontalSlider("level", &fHslider0, 1.0, 0.0, 1.0, 0.01);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow3 = (fConst2 * double(fHslider3));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			double fTemp1 = (65536.0 * (fRec3[0] - std::floor(fRec3[0])));
			double fTemp2 = std::floor(fTemp1);
			int iTemp3 = int(fTemp2);
			double fTemp4 = (fConst1 * (fRec1[0] * ((fRec2[0] * (((fTemp2 + (1.0 - fTemp1)) * ftbl0mydspSIG0[(iTemp3 & 65535)]) + ((fTemp1 - fTemp2) * ftbl0mydspSIG0[((iTemp3 + 1) & 65535)]))) + 1.0)));
			int iTemp5 = int(fTemp4);
			output0[i] = FAUSTFLOAT(((fRec0[0] * ((fVec0[((IOTA - (iTemp5 & 65535)) & 65535)] * (double(iTemp5) + (1.0 - fTemp4))) + ((fTemp4 - double(iTemp5)) * fVec0[((IOTA - ((iTemp5 + 1) & 65535)) & 65535)]))) + fTemp0));
			fRec0[1] = fRec0[0];
			IOTA = (IOTA + 1);
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
