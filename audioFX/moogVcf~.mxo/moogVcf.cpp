...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("moogVcf");
		ui_interface->declare(&fHslider0, "1", "");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->declare(&fHslider0, "tooltip", "The VCF resonates   at the corner frequency. The VCF response is flat below the corner frequency, and rolls off -24 dB per   octave above.");
		ui_interface->declare(&fHslider0, "unit", "PK");
		ui_interface->addHorizontalSlider("Corner Frequency", &fHslider0, 440.0, 20.0, 5000.0, 1.0);
		...
		ui_interface->addHorizontalSlider("Corner Resonance", &fHslider1, 0.90000000000000002, 0.0, 1.0, 0.01);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow2 = (0.0 - (4.0 * max(0.0, min(mydsp_faustpower4_f(double(fHslider1)), 0.99999899999999997))));
		double fSlow3 = (1.0 - fSlow0);
		for (int i = 0; (i < count); i = (i + 1)) {
			double fTemp0 = double(input0[i]);
			fRec5[0] = (fSlow1 + (0.999 * fRec5[1]));
			double fTemp1 = (fConst0 * fRec5[0]);
			double fTemp2 = (1.0 - fTemp1);
			fRec4[0] = ((fSlow0 * fTemp0) + ((fTemp2 * fRec4[1]) + (fSlow2 * fRec0[1])));
			fRec3[0] = (fRec4[0] + (fTemp2 * fRec3[1]));
			fRec2[0] = (fRec3[0] + (fTemp2 * fRec2[1]));
			fRec1[0] = (fRec2[0] + (fRec1[1] * fTemp2));
			fRec0[0] = (fRec1[0] * pow(fTemp1, 4.0));
