/* ------------------------------------------------------------
author: "Guitarix"
name: "Tonestack Emulation Vox AC-15"
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("description", "VOX AC-15");
		m->declare("filename", "toneStackVoxAc15");
		...
		m->declare("name", "Tonestack Emulation Vox AC-15");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Tonestack Emulation Vox AC-15");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow5 = (((0.00010719478000000002 * fSlow2) + (fSlow0 * (((0.00022854915600000004 * fSlow2) + 0.00012621831200000002) - fSlow4))) + 0.00010871476000000002);
		...
		double fSlow12 = ((fSlow1 + (0.00010340000000000001 * fSlow11)) + (0.022103400000000002 * fSlow7));
		double fSlow13 = (fConst0 * (0.0 - fSlow12));
		double fSlow14 = ((((1.5199800000000001e-06 * fSlow11) + (fSlow0 * (0.00022961831200000004 - fSlow4))) + (fSlow2 * (fSlow4 + 3.7947800000000004e-06))) + 3.7947800000000004e-06);
		double fSlow15 = ((3.4212992000000007e-08 * (fSlow0 * (fSlow6 + 1.0))) + (1.0691560000000003e-08 * (fSlow11 * (fSlow2 + (1.0 - fSlow0)))));
		double fSlow16 = (fConst0 * fSlow15);
		double fSlow17 = (fSlow13 - (fConst1 * (fSlow14 + fSlow16)));
		double fSlow18 = (fConst2 * fSlow8);
		double fSlow19 = ((fConst1 * (fSlow5 + fSlow18)) + (-3.0 - fSlow3));
		double fSlow20 = ((fSlow3 + (fConst1 * (fSlow5 - fSlow18))) + -3.0);
		double fSlow21 = (fSlow3 + (-1.0 - (fConst1 * (fSlow5 - fSlow9))));
		double fSlow22 = (fConst2 * fSlow15);
		double fSlow23 = (fSlow13 + (fConst1 * (fSlow14 + fSlow22)));
		double fSlow24 = (fConst0 * fSlow12);
		double fSlow25 = (fSlow24 + (fConst1 * (fSlow14 - fSlow22)));
		double fSlow26 = (fSlow24 - (fConst1 * (fSlow14 - fSlow16)));
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec0[0] = (double(input0[i]) - (fSlow10 * (((fSlow19 * fRec0[1]) + (fSlow20 * fRec0[2])) + (fSlow21 * fRec0[3]))));
			output0[i] = FAUSTFLOAT((fSlow10 * ((((fSlow17 * fRec0[0]) + (fSlow23 * fRec0[1])) + (fSlow25 * fRec0[2])) + (fSlow26 * fRec0[3]))));
