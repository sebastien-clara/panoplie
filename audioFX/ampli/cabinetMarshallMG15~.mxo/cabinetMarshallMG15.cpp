...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "cabinetMarshallMG15");
		...
		m->declare("name", "cabinetMarshallMG15");
	}
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst1 = pow(0.001, (1.0 / (4.3449334370399999 * fConst0)));
		fConst2 = (cos((992.92621562344266 / fConst0)) * (0.0 - (2.0 * fConst1)));
		fConst3 = mydsp_faustpower2_f(fConst1);
		fConst4 = pow(0.001, (1.0 / (3.6207909218199998 * fConst0)));
		fConst5 = (cos((1799.6787658151336 / fConst0)) * (0.0 - (2.0 * fConst4)));
		fConst6 = mydsp_faustpower2_f(fConst4);
		fConst7 = pow(0.001, (1.0 / (0.040913499021399999 * fConst0)));
		fConst8 = (cos((2668.4892044777916 / fConst0)) * (0.0 - (2.0 * fConst7)));
		fConst9 = mydsp_faustpower2_f(fConst7);
		fConst10 = pow(0.001, (1.0 / (0.044143858564700003 * fConst0)));
		fConst11 = (cos((3413.1838661985148 / fConst0)) * (0.0 - (2.0 * fConst10)));
		fConst12 = mydsp_faustpower2_f(fConst10);
		fConst13 = pow(0.001, (1.0 / (0.045431783226399999 * fConst0)));
		fConst14 = (cos((4219.9364163902064 / fConst0)) * (0.0 - (2.0 * fConst13)));
		fConst15 = mydsp_faustpower2_f(fConst13);
		fConst16 = pow(0.001, (1.0 / (0.050836037922399997 * fConst0)));
		fConst17 = (cos((6019.6151821990561 / fConst0)) * (0.0 - (2.0 * fConst16)));
		fConst18 = mydsp_faustpower2_f(fConst16);
		fConst19 = pow(0.001, (1.0 / (0.80468114200999996 * fConst0)));
		fConst20 = (cos((10736.014706394699 / fConst0)) * (0.0 - (2.0 * fConst19)));
		fConst21 = mydsp_faustpower2_f(fConst19);
		fConst22 = pow(0.001, (1.0 / (0.21732110868400001 * fConst0)));
		fConst23 = (cos((13404.503910872492 / fConst0)) * (0.0 - (2.0 * fConst22)));
		fConst24 = mydsp_faustpower2_f(fConst22);
		fConst25 = pow(0.001, (1.0 / (0.157500643606 * fConst0)));
		fConst26 = (cos((26560.77626787368 / fConst0)) * (0.0 - (2.0 * fConst25)));
		fConst27 = mydsp_faustpower2_f(fConst25);
		fConst28 = pow(0.001, (1.0 / (0.026998216781699998 * fConst0)));
		fConst29 = (cos((47784.574126728941 / fConst0)) * (0.0 - (2.0 * fConst28)));
		fConst30 = mydsp_faustpower2_f(fConst28);
		fConst31 = pow(0.001, (1.0 / (0.0265069810392 * fConst0)));
		fConst32 = (cos((48591.326676952056 / fConst0)) * (0.0 - (2.0 * fConst31)));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("cabinetMarshallMG15");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output0[i] = FAUSTFLOAT((fTemp0 * (fSlow1 + (fSlow0 * (((((((((((0.611078749629 * (fRec0[0] - fRec0[2])) + (0.34789209720999997 * (fRec1[0] - fRec1[2]))) + (0.171554261056 * (fRec2[0] - fRec2[2]))) + (0.204626822018 * (fRec3[0] - fRec3[2]))) + (0.21461155688799999 * (fRec4[0] - fRec4[2]))) + (0.22679075026699999 * (fRec5[0] - fRec5[2]))) + (fRec6[0] - fRec6[2])) + (0.55942591206400005 * (fRec7[0] - fRec7[2]))) + (0.39064218835600001 * (fRec8[0] - fRec8[2]))) + (0.0132517118767 * (fRec9[0] - fRec9[2]))) + (0.0119132128807 * (fRec10[0] - fRec10[2])))))));
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
			fRec1[2] = fRec1[1];
			fRec1[1] = fRec1[0];
