...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Flange Delay", &fHslider3, 10.0, 0.0, 20.0, 0.001);
		ui_interface->declare(&fHslider2, "2", "");
		ui_interface->declare(&fHslider2, "style", "knob");
		ui_interface->declare(&fHslider2, "unit", "ms");
		ui_interface->addHorizontalSlider("Delay Offset", &fHslider2, 1.0, 0.0, 20.0, 0.001);
		ui_interface->declare(&fHslider4, "3", "");
		ui_interface->declare(&fHslider4, "style", "knob");
		ui_interface->declare(&fHslider4, "unit", "Hz");
		ui_interface->addHorizontalSlider("Speed", &fHslider4, 0.5, 0.0, 10.0, 0.01);
		ui_interface->declare(&fHslider0, "4", "");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->addHorizontalSlider("Depth", &fHslider0, 1.0, 0.0, 1.0, 0.001);
		ui_interface->declare(&fHslider1, "5", "");
		ui_interface->declare(&fHslider1, "style", "knob");
		ui_interface->addHorizontalSlider("Feedback", &fHslider1, 0.0, -0.999, 0.999, 0.001);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow1 = (int(double(fCheckbox0))?(0.0 - fSlow0):fSlow0);
		double fSlow2 = double(fHslider1);
		double fSlow3 = double(fVslider0);
		double fSlow4 = (0.001 * double(fHslider2));
		double fSlow5 = (0.00050000000000000001 * double(fHslider3));
		double fSlow6 = (fConst1 * double(fHslider4));
		double fSlow7 = (1.0 - fSlow3);
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			double fTemp0 = double(input0[i]);
			double fTemp1 = (fSlow3 * fTemp0);
			double fTemp2 = ((fSlow2 * fRec0[1]) - fTemp1);
			fVec1[(IOTA & 4095)] = fTemp2;
			fRec3[0] = (fRec3[1] + (fSlow6 * (0.0 - fRec1[1])));
			fRec2[0] = ((fRec2[1] + (fSlow6 * fRec3[0])) + double((1 - iVec0[1])));
			fRec1[0] = fRec2[0];
			double fTemp3 = (fConst0 * (fSlow4 + (fSlow5 * (fRec1[0] + 1.0))));
			int iTemp4 = int(fTemp3);
			double fTemp5 = floor(fTemp3);
			fRec0[0] = ((fVec1[((IOTA - min(2049, max(0, iTemp4))) & 4095)] * (fTemp5 + (1.0 - fTemp3))) + ((fTemp3 - fTemp5) * fVec1[((IOTA - min(2049, max(0, (iTemp4 + 1)))) & 4095)]));
			output0[i] = FAUSTFLOAT(((0.5 * ((fSlow1 * fRec0[0]) + fTemp1)) + (fSlow7 * fTemp0)));
			iVec0[1] = iVec0[0];
			IOTA = (IOTA + 1);
			fRec3[1] = fRec3[0];
			fRec2[1] = fRec2[0];
