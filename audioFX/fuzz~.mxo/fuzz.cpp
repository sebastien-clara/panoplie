...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("description", "A simple waveshaping effect");
		m->declare("filename", "fuzz");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("distortion", &fHslider2, 12.0, 0.0, 100.0, 0.10000000000000001);
		ui_interface->declare(&fHslider0, "3", "");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->addHorizontalSlider("amount", &fHslider0, 1.0, 0.0, 1.0, 0.01);
		ui_interface->declare(&fHslider3, "9", "");
		ui_interface->declare(&fHslider3, "style", "knob");
		ui_interface->addHorizontalSlider("gain", &fHslider3, 3.0, -96.0, 96.0, 0.10000000000000001);
		ui_interface->declare(&fHslider1, "name", "Tone");
		ui_interface->declare(&fHslider1, "style", "knob");
		ui_interface->addHorizontalSlider("tone", &fHslider1, 400.0, 100.0, 2000.0, 1.0);
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow1 = (1.0 / tan((fConst0 * double(fHslider1))));
		double fSlow2 = (fSlow1 + 1.0);
		double fSlow3 = (0.0 - ((1.0 - fSlow1) / fSlow2));
		double fSlow4 = (1.0 / fSlow2);
		double fSlow5 = double(fHslider2);
		double fSlow6 = (1.0 / sqrt((fSlow5 + 1.0)));
		double fSlow7 = (0.0010000000000000009 * double(fHslider3));
		double fSlow8 = pow(10.0, (0.050000000000000003 * fSlow5));
		double fSlow9 = (fSlow8 + -1.0);
		for (int i = 0; (i < count); i = (i + 1)) {
			double fTemp0 = double(input0[i]);
			fRec0[0] = (fSlow0 + (0.999 * fRec0[1]));
			double fTemp1 = (fTemp0 * fRec0[0]);
			fRec2[0] = (fSlow7 + (0.999 * fRec2[1]));
			double fTemp2 = fabs(fTemp1);
			double fTemp3 = (fSlow6 * (((fTemp1 * pow(10.0, (0.050000000000000003 * fRec2[0]))) * (fSlow8 + fTemp2)) / (((mydsp_faustpower2_f(fTemp0) * mydsp_faustpower2_f(fRec0[0])) + (fSlow9 * fTemp2)) + 1.0)));
			fVec0[0] = fTemp3;
			fRec1[0] = ((fSlow3 * fRec1[1]) + (fSlow4 * (fTemp3 + fVec0[1])));
			output0[i] = FAUSTFLOAT(((fTemp0 * (1.0 - fRec0[0])) + fRec1[0]));
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			fVec0[1] = fVec0[0];
			fRec1[1] = fRec1[0];
