...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("wah4");
		ui_interface->declare(&fVslider0, "1", "");
		ui_interface->declare(&fVslider0, "scale", "log");
		ui_interface->declare(&fVslider0, "style", "knob");
		ui_interface->declare(&fVslider0, "tooltip", "wah resonance frequency in Hz");
		ui_interface->addVerticalSlider("Resonance Frequency", &fVslider0, 200.0, 100.0, 2000.0, 1.0);
		ui_interface->declare(&fVslider1, "2", "");
		ui_interface->declare(&fVslider1, "style", "knob");
		ui_interface->addVerticalSlider("amount", &fVslider1, 1.0, 0.0, 1.0, 0.01);
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			double fTemp0 = (fConst0 * fRec5[0]);
			double fTemp1 = (1.0 - fTemp0);
			double fTemp2 = double(input0[i]);
			fRec4[0] = (((fTemp1 * fRec4[1]) + (fSlow1 * fTemp2)) - (3.2000000000000002 * fRec0[1]));
			fRec3[0] = (fRec4[0] + (fTemp1 * fRec3[1]));
			fRec2[0] = (fRec3[0] + (fTemp1 * fRec2[1]));
			fRec1[0] = (fRec2[0] + (fRec1[1] * fTemp1));
			fRec0[0] = (fRec1[0] * pow(fTemp0, 4.0));
			output0[i] = FAUSTFLOAT(((4.0 * fRec0[0]) + (fSlow2 * fTemp2)));
			fRec5[1] = fRec5[0];
			fRec4[1] = fRec4[0];
			fRec3[1] = fRec3[0];
			fRec2[1] = fRec2[0];
