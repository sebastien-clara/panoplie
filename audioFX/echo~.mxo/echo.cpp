...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("description", "delay with feedback");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("delay", &fHslider2, 0.001, 0.0, 5.0, 0.001);
		ui_interface->declare(&fHslider1, "2", "");
		ui_interface->declare(&fHslider1, "style", "knob");
		ui_interface->addHorizontalSlider("feedback", &fHslider1, 0.0, 0.0, 0.98999999999999999, 0.001);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			double fTemp1 = (fConst0 * fRec2[0]);
			int iTemp2 = int(fTemp1);
			fRec1[(IOTA & 524287)] = ((fTemp0 * fRec0[0]) + (fSlow1 * ((fRec1[((IOTA - (((iTemp2 + 1) & 262143) + 1)) & 524287)] * (fTemp1 - double(iTemp2))) + (fRec1[((IOTA - ((iTemp2 & 262143) + 1)) & 524287)] * (double(iTemp2) + (1.0 - fTemp1))))));
			output0[i] = FAUSTFLOAT(((fTemp0 * (1.0 - fRec0[0])) + fRec1[((IOTA - 0) & 524287)]));
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			IOTA = (IOTA + 1);
