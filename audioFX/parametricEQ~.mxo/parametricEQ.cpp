...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "parametricEQ");
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst2 = (1.0 / fConst0);
		fConst3 = (3.1415926535897931 * fConst2);
		fConst4 = (6.2831853071795862 * fConst2);
		
	}
	
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(8000.0);
		fHslider1 = FAUSTFLOAT(200.0);
		fHslider2 = FAUSTFLOAT(0.0);
		fHslider3 = FAUSTFLOAT(2500.0);
		fHslider4 = FAUSTFLOAT(0.0);
		fHslider5 = FAUSTFLOAT(10.0);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Low Boost|Cut", &fHslider2, 0.0, -40.0, 40.0, 0.10000000000000001);
		ui_interface->declare(&fHslider1, "1", "");
		ui_interface->declare(&fHslider1, "scale", "log");
		ui_interface->declare(&fHslider1, "style", "knob");
		ui_interface->declare(&fHslider1, "tooltip", "Transition-frequency from boost (cut) to unity gain");
		ui_interface->declare(&fHslider1, "unit", "Hz");
		ui_interface->addHorizontalSlider("Transition Frequency", &fHslider1, 200.0, 1.0, 5000.0, 1.0);
		...
		ui_interface->addHorizontalSlider("Peak Boost|Cut", &fHslider4, 0.0, -40.0, 40.0, 0.10000000000000001);
		ui_interface->declare(&fHslider3, "1", "");
		ui_interface->declare(&fHslider3, "style", "knob");
		ui_interface->declare(&fHslider3, "tooltip", "Peak    Frequency");
		ui_interface->declare(&fHslider3, "unit", "Hz");
		ui_interface->addHorizontalSlider("Peak Frequency", &fHslider3, 2500.0, 20.0, 10000.0, 1.0);
		...
		ui_interface->addHorizontalSlider("Peak Q", &fHslider5, 10.0, 0.10000000000000001, 100.0, 0.10000000000000001);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("High Boost|Cut", &fHslider6, 0.0, -40.0, 40.0, 0.10000000000000001);
		ui_interface->declare(&fHslider0, "1", "");
		ui_interface->declare(&fHslider0, "scale", "log");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->declare(&fHslider0, "tooltip", "Transition-frequency from boost (cut) to unity gain");
		ui_interface->declare(&fHslider0, "unit", "Hz");
		ui_interface->addHorizontalSlider("Transition Frequency", &fHslider0, 8000.0, 20.0, 10000.0, 1.0);
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow2 = (1.0 / (((fSlow1 + 1.0000000000000002) / fSlow0) + 1.0));
		double fSlow3 = (fSlow1 + 1.0);
		double fSlow4 = (0.0 - ((1.0 - fSlow1) / fSlow3));
		double fSlow5 = (1.0 / fSlow3);
		double fSlow6 = std::tan((fConst1 * double(fHslider1)));
		double fSlow7 = (1.0 / fSlow6);
		double fSlow8 = (1.0 / (((fSlow7 + 1.0000000000000002) / fSlow6) + 1.0));
		double fSlow9 = (1.0 / mydsp_faustpower2_f(fSlow6));
		double fSlow10 = (2.0 * (0.0 - fSlow9));
		double fSlow11 = (fSlow7 + 1.0);
		double fSlow12 = (0.0 - ((1.0 - fSlow7) / fSlow11));
		double fSlow13 = (1.0 / fSlow11);
		double fSlow14 = (0.0 - fSlow7);
		double fSlow15 = (((fSlow7 + -1.0000000000000002) / fSlow6) + 1.0);
		double fSlow16 = (2.0 * (1.0 - fSlow9));
		double fSlow17 = std::pow(10.0, (0.050000000000000003 * double(fHslider2)));
		double fSlow18 = (0.0010000000000000009 * double(fHslider3));
		double fSlow19 = double(fHslider4);
		int iSlow20 = (fSlow19 > 0.0);
		double fSlow21 = double(fHslider5);
		double fSlow22 = (fConst3 * (std::pow(10.0, (0.050000000000000003 * std::fabs(fSlow19))) / fSlow21));
		double fSlow23 = (fConst3 / fSlow21);
		double fSlow24 = (((fSlow1 + -1.0000000000000002) / fSlow0) + 1.0);
		double fSlow25 = (1.0 / mydsp_faustpower2_f(fSlow0));
		double fSlow26 = (2.0 * (1.0 - fSlow25));
		double fSlow27 = std::pow(10.0, (0.050000000000000003 * double(fHslider6)));
		double fSlow28 = (2.0 * (0.0 - fSlow25));
		double fSlow29 = (0.0 - fSlow1);
		for (int i = 0; (i < count); i = (i + 1)) {
			double fTemp0 = double(input0[i]);
			fVec0[0] = fTemp0;
			fRec4[0] = ((fSlow12 * fRec4[1]) + (fSlow13 * ((fSlow7 * fTemp0) + (fSlow14 * fVec0[1]))));
			fRec3[0] = (fRec4[0] - (fSlow8 * ((fSlow15 * fRec3[2]) + (fSlow16 * fRec3[1]))));
			fRec6[0] = ((fSlow12 * fRec6[1]) + (fSlow13 * (fTemp0 + fVec0[1])));
			fRec5[0] = (fRec6[0] - (fSlow8 * ((fSlow15 * fRec5[2]) + (fSlow16 * fRec5[1]))));
			fRec7[0] = (fSlow18 + (0.999 * fRec7[1]));
			double fTemp1 = std::tan((fConst1 * fRec7[0]));
			double fTemp2 = (1.0 / fTemp1);
			double fTemp3 = (fRec7[0] / std::sin((fConst4 * fRec7[0])));
			double fTemp4 = (fSlow22 * fTemp3);
			double fTemp5 = (fSlow23 * fTemp3);
			double fTemp6 = (iSlow20?fTemp5:fTemp4);
			double fTemp7 = (2.0 * (fRec2[1] * (1.0 - (1.0 / mydsp_faustpower2_f(fTemp1)))));
			double fTemp8 = (((fTemp2 + fTemp6) / fTemp1) + 1.0);
			fRec2[0] = ((fSlow8 * (((fSlow10 * fRec3[1]) + (fSlow17 * (fRec5[0] + (fRec5[2] + (2.0 * fRec5[1]))))) + (fSlow9 * (fRec3[2] + fRec3[0])))) - (((fRec2[2] * (((fTemp2 - fTemp6) / fTemp1) + 1.0)) + fTemp7) / fTemp8));
			double fTemp9 = (iSlow20?fTemp4:fTemp5);
			double fTemp10 = (((fRec2[0] * (((fTemp2 + fTemp9) / fTemp1) + 1.0)) + (fTemp7 + (fRec2[2] * (1.0 - ((fTemp9 - fTemp2) / fTemp1))))) / fTemp8);
			fVec1[0] = fTemp10;
			fRec1[0] = ((fSlow4 * fRec1[1]) + (fSlow5 * (fTemp10 + fVec1[1])));
			fRec0[0] = (fRec1[0] - (fSlow2 * ((fSlow24 * fRec0[2]) + (fSlow26 * fRec0[1]))));
			fRec9[0] = ((fSlow4 * fRec9[1]) + (fSlow5 * ((fSlow1 * fTemp10) + (fSlow29 * fVec1[1]))));
			fRec8[0] = (fRec9[0] - (fSlow2 * ((fSlow24 * fRec8[2]) + (fSlow26 * fRec8[1]))));
			output0[i] = FAUSTFLOAT((fSlow2 * ((fRec0[2] + (fRec0[0] + (2.0 * fRec0[1]))) + (fSlow27 * ((fSlow28 * fRec8[1]) + (fSlow25 * (fRec8[2] + fRec8[0])))))));
			fVec0[1] = fVec0[0];
			fRec4[1] = fRec4[0];
			fRec3[2] = fRec3[1];
			fRec3[1] = fRec3[0];
