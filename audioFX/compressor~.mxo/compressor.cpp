...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Ratio", &fHslider2, 5.0, 1.0, 20.0, 0.10000000000000001);
		...
		ui_interface->addHorizontalSlider("Threshold", &fHslider4, -30.0, -100.0, 10.0, 0.10000000000000001);
		...
		ui_interface->addHorizontalSlider("Attack", &fHslider1, 50.0, 1.0, 1000.0, 0.10000000000000001);
		...
		ui_interface->addHorizontalSlider("Makeup Gain", &fHslider0, 40.0, -96.0, 96.0, 0.10000000000000001);
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow1 = max(fConst2, (0.001 * double(fHslider1)));
		double fSlow2 = exp((0.0 - (fConst1 / fSlow1)));
		double fSlow3 = (((1.0 / double(fHslider2)) + -1.0) * (1.0 - fSlow2));
		double fSlow4 = exp((0.0 - (fConst2 / fSlow1)));
		double fSlow5 = exp((0.0 - (fConst2 / max(fConst2, (0.001 * double(fHslider3))))));
		double fSlow6 = double(fHslider4);
		for (int i = 0; (i < count); i = (i + 1)) {
			double fTemp0 = double(input0[i]);
			fRec0[0] = (fSlow0 + (0.999 * fRec0[1]));
			double fTemp1 = fabs(fTemp0);
			double fTemp2 = ((fRec2[1] > fTemp1)?fSlow5:fSlow4);
			fRec3[0] = ((fRec3[1] * fTemp2) + (fTemp1 * (1.0 - fTemp2)));
			fRec2[0] = fRec3[0];
			fRec1[0] = ((fSlow2 * fRec1[1]) + (fSlow3 * max(((20.0 * log10(fRec2[0])) - fSlow6), 0.0)));
			output0[i] = FAUSTFLOAT(((fTemp0 * fRec0[0]) * pow(10.0, (0.050000000000000003 * fRec1[0]))));
			fRec0[1] = fRec0[0];
			fRec3[1] = fRec3[0];
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
