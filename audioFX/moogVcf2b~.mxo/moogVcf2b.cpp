...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow2 = min(1.4141994202374715, (1.4142135623730951 * double(fHslider0)));
		double fSlow3 = (fSlow2 * (fSlow2 + 1.4142135623730951));
		double fSlow4 = (0.0010000000000000009 * double(fHslider1));
		double fSlow5 = (1.4142135623730951 * fSlow2);
		double fSlow6 = (fSlow5 + 2.0);
		double fSlow7 = (fSlow2 * (fSlow2 + -1.4142135623730951));
		double fSlow8 = (2.0 - fSlow5);
		for (int i = 0; (i < count); i = (i + 1)) {
			double fTemp0 = double(input0[i]);
			fRec2[0] = (fSlow4 + (0.999 * fRec2[1]));
			double fTemp1 = tan((fConst0 * max(20.0, min(10000.0, fRec2[0]))));
			double fTemp2 = (1.0 / fTemp1);
			double fTemp3 = (1.0 - (1.0 / mydsp_faustpower2_f(fTemp1)));
			double fTemp4 = (fSlow3 + (((fSlow6 + fTemp2) / fTemp1) + 1.0));
			fRec1[0] = ((fSlow0 * fTemp0) - (((fRec1[2] * (fSlow3 + (((fTemp2 - fSlow6) / fTemp1) + 1.0))) + (2.0 * (fRec1[1] * (fSlow3 + fTemp3)))) / fTemp4));
			double fTemp5 = (fSlow7 + (((fSlow8 + fTemp2) / fTemp1) + 1.0));
			fRec0[0] = (((fRec1[2] + (fRec1[0] + (2.0 * fRec1[1]))) / fTemp4) - (((fRec0[2] * (fSlow7 + (((fTemp2 - fSlow8) / fTemp1) + 1.0))) + (2.0 * (fRec0[1] * (fSlow7 + fTemp3)))) / fTemp5));
			output0[i] = FAUSTFLOAT(((fSlow1 * fTemp0) + ((fRec0[2] + (fRec0[0] + (2.0 * fRec0[1]))) / fTemp5)));
			fRec2[1] = fRec2[0];
			fRec1[2] = fRec1[1];
			fRec1[1] = fRec1[0];
			fRec0[2] = fRec0[1];
